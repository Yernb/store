                ...
                <div className="flex items-center justify-between gap-4 flex-wrap">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      className="px-3 py-1.5 text-sm border border-gray-300 rounded-md bg-white text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    >
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-4">
                          <div className="flex-1">
                            <label className="block text-xs text-gray-600 mb-1">Min: ${priceRange.min.toFixed(0)}</label>
                            <input
                              type="range"
                              min={priceStats.min}
                              max={priceStats.max}
                          ...
                          <div className="flex-1">
                            <label className="block text-xs text-gray-600 mb-1">Max: ${priceRange.max.toFixed(0)}</label>
                            <input
                              type="range"
                              min={priceStats.min}
                              max={priceStats.max}
                        ...
                        <div className="flex items-center gap-2 text-xs text-gray-600">
                          <span>${priceStats.min.toFixed(0)}</span>
                          <div className="flex-1 border-t border-gray-300"></div>
                          <span>${priceStats.max.toFixed(0)}</span>
                        </div>
                      </div>
                    </div>
